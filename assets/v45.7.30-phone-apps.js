/* =========================================================
   POKEJI V45.7.30 · Virtual Phone Apps Rebuild
...
(function(){
  ...
  window.v43OpenPhoneApp=(function(){
    const original=window.v43OpenPhoneApp;
    return function(owner,appId){
      if(apps[appId]){
        const content=apps[appId](owner);
        const container=document.querySelector('#modalContent .phone-screen');
  ...
  console.log('[V45.7.30 Phone Apps] 虚拟手机应用已重做');
})();
