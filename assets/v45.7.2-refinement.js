/* =========================================================
   POKEJI V45.7.7 · layered appearance and square stability
   ========================================================= */
(function(){
  'use strict';
  ...
  function reportSquareError(error){console.error('V45.7.7 square recovery',error);if(typeof errorDetail==='function')errorDetail(error,'广场页面异常已拦截');else if(typeof toast==='function')toast('广场页面数据已修复，请重新打开')}
...
(function(){
  ...
  function repairApiLibrary({persist=false,runLegacy=false}={}){
    ...
    if(runLegacy)try{changed=migrateLegacyModels()||changed}catch(error){console.warn('V45.7.7 legacy API migration skipped',error)}
