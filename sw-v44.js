const POKEJI_WORKER_VERSION = '45.7.29';
const CACHE_NAME = 'pokeji-v45.7.29';
...
const APP_SHELL = [
  '/',
  APP_ENTRY,
  "/assets/app.css?v=45.7.29",
  "/assets/app.js?v=45.7.29",
  "/assets/v45-patch.js?v=45.7.29",
  "/assets/v45-final.js?v=45.7.29",
  "/assets/v45-ui-fix.js?v=45.7.29",
  "/assets/v45-phone-call.js?v=45.7.29",
  "/assets/v45-followup.js?v=45.7.29",
  "/assets/v45-stability.js?v=45.7.29",
  "/assets/v45.1-fix.js?v=45.7.29",
    /* original phone desktop preserved */
  "/assets/v45.1-memory-entries.js?v=45.7.29",
  "/assets/v45.1-scope-override.css?v=45.7.29",
  "/assets/v45.2-app-interiors.css?v=45.7.29",
  "/assets/v45.2-app-interiors.js?v=45.7.29",
  "/assets/pako-inflate.min.js?v=45.7.29",
  "/assets/v45.3-repair.css?v=45.7.29",
  "/assets/v45.3-repair.js?v=45.7.29",
  "/assets/v45.4-next-stage.css?v=45.7.29",
  "/assets/v45.4-next-stage.js?v=45.7.29",
  "/assets/v45.4.1-runtime.css?v=45.7.29",
  "/assets/v45.4.1-phone.css?v=45.7.29",
  "/assets/v45.4.1-story.css?v=45.7.29",
  "/assets/v45.4.1-core.js?v=45.7.29",
  "/assets/v45.4.1-runtime.js?v=45.7.29",
  "/assets/v45.4.1-phone.js?v=45.7.29",
  "/assets/v45.4.1-story.js?v=45.7.29",
  "/assets/v45.5.0-framework.css?v=45.7.29",
  "/assets/v45.5.0-framework.js?v=45.7.29",
  "/assets/v45.6.0-refinement.css?v=45.7.29",
  "/assets/v45.6.0-refinement.js?v=45.7.29",
  "/assets/v45.7.0-polish.css?v=45.7.29",
  "/assets/v45.7.0-polish.js?v=45.7.29",
  "/assets/v45.7.1-refinement.css?v=45.7.29",
  "/assets/v45.7.1-refinement.js?v=45.7.29",
  "/assets/v45.7.2-refinement.css?v=45.7.29",
  "/assets/v45.7.2-refinement.js?v=45.7.29",
  "/assets/v45.7.9-icon-mode.css?v=45.7.29",
  "/assets/v45.7.12-refinement.css?v=45.7.29",
  "/assets/v45.7.13-plain.css?v=45.7.29",
  "/assets/v45.7.14-phone-plain.css?v=45.7.29",
  "/assets/v45.7.17-lines.css?v=45.7.29",
  "/assets/v45.7.17-global-white.css?v=45.7.29",
  "/assets/v45.7.29-fixes.css?v=45.7.29",
  "/assets/v45.7.29-frameworks.css?v=45.7.29",
  "/assets/v45.7.9-icon-mode.js?v=45.7.29",
  "/assets/v45.7.12-refinement.js?v=45.7.29",
  "/assets/v45.7.29-a.js?v=45.7.29",
  "/assets/v45.7.29-b.js?v=45.7.29",
  "/assets/v45.7.29-p0-fixes.js?v=45.7.29",
  "/assets/v45.7.29-p1-frameworks.js?v=45.7.29",
  "/manifest.webmanifest?v=45.7.29",
  '/assets/icon-192.png?v=45.7.29',
  '/assets/icon-512.png?v=45.7.29',
...
async function showTaskNotification(taskId, meta, state) {
  ...
  const details = state === 'working'
    ...
    : state === 'completed'
      ? {title: `${name}已完成`, body: meta.operation === 'proactive' ? '收到一条主动说话，打开扑克机查看。' : '回复已生成，打开扑克机查看。'}
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async () => {
    const cache = await caches.open(CACHE_NAME);
    const recoveryPage=url.pathname==='/repair-sw.html'||url.pathname==='/startup-repair.html'||url.pathname==='/build-info.json';
    const forceFresh=recoveryPage||event.request.mode==='navigate'||url.pathname==='/index.html'||url.pathname==='/';
    try {
      const preload = event.request.mode === 'navigate' ? await event.preloadResponse : null;
      const response = preload || await fetch(forceFresh?new Request(event.request,{cache:'no-store'}):event.request);
      if (response.ok&&!recoveryPage) {
